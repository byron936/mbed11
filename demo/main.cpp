...
void get_acc(Arguments *in, Reply *out);
...
RPCFunction rpc_get_acc(&get_acc, "get_acc");
...
int main()
{
    ...
    xbee.write("ATMY 0x243\r\n", 12);
    reply_messange(xbee_reply, "setting MY : 0x243");

    xbee.write("ATDL 0x143\r\n", 12);
    reply_messange(xbee_reply, "setting DL : 0x143");
...
void get_acc(Arguments *in, Reply *out)
{
    ...
    printf("acceleration vector: %d, %d, %d\n", pDataXYZ[0], pDataXYZ[1], pDataXYZ[2]);
